...
#include "../../../esp_cam_io_parl-v0.1.0-beta.2/sensors/private_include/ov5640_regs.h"
#include "esp_attr.h"

static const ratio_settings_t ratio_table[] = {
    //  mw,   mh,  sx,  sy,   ex,   ey, ox, oy,   tx,   ty
    { 2592, 1944,   0,   0, 2623, 1951, 16, 4, 2844, 1968 }, //4x3
    { 2592, 1728,   0, 110, 2623, 1843, 16, 4, 2844, 1752 }, //3x2
    { 2592, 1620,   0, 160, 2623, 1791, 16, 4, 2844, 1648 }, //16x10
    { 2560, 1536,   0, 192, 2623, 1759, 32, 16, 2844, 1584 }, //5x3
    { 2592, 1458,   0, 240, 2623, 1711, 16, 4, 2844, 1488 }, //16x9
    { 2560, 1080,   0, 420, 2623, 1531, 32, 16, 2844, 1128 }, //21x9
    { 2430, 1944,  80,   0, 2543, 1951, 16, 4, 2684, 1968 }, //5x4
    { 1944, 1944,   0,   0, 2623, 1951, 240, 4, 2684, 1968 }, //1x1
    { 1088, 1944, 736,   0, 1887, 1951, 16, 4, 1884, 1968 }  //9x16
};
...
static const uint8_t sensor_autofocus_config[] = {
